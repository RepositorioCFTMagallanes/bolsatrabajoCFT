...
{{ $estudiante->resumen ?? '' }}</textarea>
        ...
        <section class="card">
            ...
            <div class="field">
                <label for="cursos">Cursos / Certificaciones</label>
                <textarea id="cursos" name="cursos" rows="2" maxlength="2000">
{{ $estudiante->cursos ?? '' }}</textarea>
            </div>
        </section>
        ...
        <section class="card">
            ...
            <div class="field">
                <label for="portfolio">Portafolio / Sitio</label>
