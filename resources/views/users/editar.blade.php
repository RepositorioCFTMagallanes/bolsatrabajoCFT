...
@section('content')
    ...
    @php
        ...
        $cvUrl = $estudiante->cv_blob ? url('/estudiante/cv/' . $estudiante->id) : null;
    @endphp
                ...
                <div class="grid-2">
                    <div class="field">
                        ...
                        <div class="avatar-row">
                            <img class="avatar-preview" src="{{ $avatarUrl }}" alt="Avatar actual">
                ...
                <div class="grid-3">
                    ...
                    <div class="field">
                        ...
                        <select id="area" name="area">
                            ...
                            <option value="3" {{ ($estudiante->area_interes_id ?? '') == 3 ? 'selected' : '' }}>
                                Logística</option>
                            <option value="4" {{ ($estudiante->area_interes_id ?? '') == 4 ? 'selected' : '' }}>
                                Turismo</option>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select id="jornada" name="jornada">
                            <option value="1"
                                {{ ($estudiante->jornada_preferencia_id ?? '') == 1 ? 'selected' : '' }}>Completa</option>
                            <option value="2"
                                {{ ($estudiante->jornada_preferencia_id ?? '') == 2 ? 'selected' : '' }}>Media jornada
                            </option>
                            <option value="3"
                                {{ ($estudiante->jornada_preferencia_id ?? '') == 3 ? 'selected' : '' }}>Práctica</option>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select id="modalidad" name="modalidad">
                            <option value="1"
                                {{ ($estudiante->modalidad_preferencia_id ?? '') == 1 ? 'selected' : '' }}>Presencial
                            </option>
                            <option value="2"
                                {{ ($estudiante->modalidad_preferencia_id ?? '') == 2 ? 'selected' : '' }}>Híbrido</option>
                            <option value="3"
                                {{ ($estudiante->modalidad_preferencia_id ?? '') == 3 ? 'selected' : '' }}>Remoto</option>
                        </select>
                    </div>
