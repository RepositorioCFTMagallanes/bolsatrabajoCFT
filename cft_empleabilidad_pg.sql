...
CREATE TABLE empresas (
  ...
  ruta_logo varchar DEFAULT NULL,
  nombre_comercial varchar DEFAULT NULL,
  razon_social varchar DEFAULT NULL,
  rut varchar DEFAULT NULL,
  ...
  sitio_web varchar DEFAULT NULL,
  ...
  correo_postulaciones varchar DEFAULT NULL,
  url_postulaciones varchar DEFAULT NULL,
  mostrar_sueldo tinyint(1) NOT NULL DEFAULT 1,
  mostrar_logo tinyint(1) NOT NULL DEFAULT 1,
  nombre_representante varchar DEFAULT NULL,
  cargo_representante varchar DEFAULT NULL,
  correo_representante varchar DEFAULT NULL,
...
CREATE TABLE estudiantes (
  id bigint UNSIGNED NOT NULL,
  usuario_id bigint UNSIGNED NOT NULL,
  run varchar DEFAULT NULL,
  estado_carrera varchar DEFAULT NULL,
  carrera varchar DEFAULT NULL,
  telefono varchar DEFAULT NULL,
  ciudad varchar DEFAULT NULL,
  resumen text DEFAULT NULL,
  institucion varchar DEFAULT NULL,
  anio_egreso year(4) DEFAULT NULL,
  cursos text DEFAULT NULL,
  ruta_cv varchar DEFAULT NULL,
  linkedin_url varchar DEFAULT NULL,
  portfolio_url varchar DEFAULT NULL,
  avatar varchar DEFAULT NULL,
  area_interes_id bigint UNSIGNED DEFAULT NULL,
  jornada_preferencia_id bigint UNSIGNED DEFAULT NULL,
  modalidad_preferencia_id bigint UNSIGNED DEFAULT NULL,
...
CREATE TABLE ofertas_trabajo (
  ...
  ruta_archivo varchar DEFAULT NULL,
...
CREATE TABLE postulaciones (
  ...
  estudiante_id bigint UNSIGNED NOT NULL,
  oferta_id bigint UNSIGNED NOT NULL,
  estado_postulacion varchar DEFAULT 'pendiente',
...
CREATE TABLE usuarios (
  ...
  token_recordar varchar DEFAULT NULL,
  creado_en timestamp NULL DEFAULT current_timestamp(),
  actualizado_en timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
